    ...
    return (
        ...
        <div className="bg-gradient-to-r from-[#F28383] from-10% via-[#9D6CD2] via-30% to-[#481EDC] to-90% flex items-center justify-center h-screen">
            <div className="max-w-[960px] bg-black-dark grid grid-cols-2 items-center gap-20 p-5 rounded-2xl">
                <div>
                    <Image className="rounded-2xl" src="/images/loginbg.png" width={300}
                        height={500} alt="bg" />
                ...
                <div className="max-w-80 grid gap-5">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 text-white">
                        ...
                        <div className="relative">
                            ...
                            <input {...register("email")} type="email" placeholder="Email Address" className="w-80 bg-white py-2 px-12 rounded-full focus:bg-black-dark focus:outline-none focus:ring-1 focus:ring-neon-blue focus:drop-shadow-lg text-blue-300" />
                        ...
                        <div className="relative">
                            ...
                            <input {...register("password")} type="text" placeholder="Password" className="w-80 bg-white-light py-2 px-12 rounded-full focus:bg-black-dark focus:outline-none focus:ring-1 focus:ring-neon-blue focus:drop-shadow-lg text-blue-300" />
                    ...
                    <div className="text-white border-t border-white-light pt-4 space-y-4 text-sm">
                        <p>Already have a account <Link href={'login'} className="text-green-500 font-semibold cursor-pointer ">Sign In</Link></p>
