...
function Navbar() {
  ...
  return (
    <div className='flex gap-11 bg-slate-900 '>
      ...
      <div className=' rounded-sm m-4 hover:text-gray-300 text-red-50 px-3 py-2' ><Link href={'login'}>LogIn</Link></div>
      <div className=' rounded-sm m-4 hover:text-gray-300 text-red-50 px-3 py-2' ><button onClick={handleSubmit}> <Link href={'/'}> <CiLogout size={25} /></Link></button></div>
